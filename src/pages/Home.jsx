...
const Home = () => {
  ...
  return (
    <section className='max-w-7xl mx-auto bg-stone-950'>
      <div>
        <h1 className='font-extrabold text-white text-[32px]'>
          The Comunity Showcase
        </h1>
        <p className='mt-2 text-[#b4b4b4] text-[16px] max-w-[500px]'>
          Browse trough a collection of the most inspiring designs and art generated by our community using the power of DALL-E AI. 
        </p>
      </div>
